...
const float l1Lim = 1/35000, l2Lim = 2/35000, l3Lim = 3/35000, l4Lim = 4/35000;       //the power threshholds of the led groups. threshhold/WEC Power scale in processing
...
void setup()
{
  ...
  analogReadResolution(12);     //analog read now runs from 0 to 4095
