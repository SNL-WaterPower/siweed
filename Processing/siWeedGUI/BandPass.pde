class BandPass {
  ...
  */
  //gains for 0.1-4hz:
  float[] gains = new float[]{0.322611774050633459687276172189740464091 , 0.322611774050633459687276172189740464091 }; 
  float[][] numerator = new float[][]{ {1, 0, -1}, {1, 0, -1} };
  float [][] denominator = new float[][]{ {1, -1.970430052852312874378526430518832057714,  0.970882548385586741090946816257201135159}, {1, -0.90603971322948251287954235522192902863 ,  0.329321471906561080711384192909463308752} };
