...
(We're working on a paper for [*HardwareX*](https://www.hardware-x.com/) that will hopefully provide an even better guide along with some data analysis from using the system.)
