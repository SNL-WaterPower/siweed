...
\begin{itemize}
\item \textbf{Torque constant verification:} The factory torque constant was verfied by logging the position and amperage of the WEC while commanding a slow sinusoidal amperage. This data was used with the diameter of the WEC to find the displacement, and calculate the torque applied for each point of given amerage. This resulted in a constant of 7.52 mNm/A, and a coefficient of friction of about 0.45mNm. The detailed process and data can be found here: \footnote{\url{https://github.com/SNL-WaterPower/siweed/issues/59}} -XX  add equation, make this a subsection, add plot as vector graphic.
\item \textbf{Wave Probes:} -XX
