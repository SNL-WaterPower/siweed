...
\hline \textbf{Cost of hardware} &
  \textit{\$6763 - Approximate cost of hardware (complete breakdown included in the Bill of Materials).}
  \\
...
The ``System Status" section shows two plots, one for the WEC and one for the Wavemaker, with each allowing the user to choose what data is plotted. 
