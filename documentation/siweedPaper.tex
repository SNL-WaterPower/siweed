...
The fit1 represents the best linear fit of the entire data set, but the data points at the highest and lowest currents are affected more significatntly by static friction, so cutting them from the data set improves the torque constant estimation, as shown in with fit2 in \figurename~\ref{fig:TorqueConstant}.
\begin{figure}[tb]
  \centering
