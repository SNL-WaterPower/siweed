...
Using this control method allows the WEC to be controlled as a spring and damper, with the proportional gain $kp$ adjusting the strength of the spring, and the derivative gain $kd$ adjusting the stregth of the damper.
