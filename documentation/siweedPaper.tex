...
\textit{Touchscreen Laptop} & \textit{Dell 210-ARYY} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Source} & \textit{Material type} \\\hline
\textit{Usb Isolator} & \textit{Name of Component 1} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Usb Hub} & \textit{Name of Component 1} & \textit{1 & \textit{Cost per unit} & \textit{Total cost} & \textit{Source} & \textit{Material type} \\\hline
\textit{Arduino Due} & \textit{Arduino Due} & \textit{2} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Level Shifter} & \textit{BSS138} & \textit{3} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Encoder Buffer} & \textit{Dual LS7366RR} & \textit{2} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Encoder} & \textit{AMT102-V} & \textit{2} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{WEC Motor Controller} & \textit{Maxon ESCON Module 24/2} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Maxon} & \textit{Material type} \\\hline
\textit{WEC Motor} & \textit{Moxon EC-max 16, 283828} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Maxon} & \textit{Material type} \\\hline
\textit{Wavemaker Motor Controller} & \textit{StepperOnline DM542T} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Source} & \textit{Material type} \\\hline
\textit{WaveMaker Motor} & \textit{StepperOnline 23HS45-4204S} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Source} & \textit{Material type} \\\hline
\textit{Power Supply} & \textit{MDS-400ADB24AA} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Power Bus} & \textit{Name of Component 1} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Estop} & \textit{Name of Component 1} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Source} & \textit{Material type} \\\hline
\textit{Inferred Limit} & \textit{485-2168} & \textit{1} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Physical Limit} & \textit{0659NB-C283} & \textit{2} & \textit{Cost per unit} & \textit{Total cost} & \textit{Digikey} & \textit{Material type} \\\hline
\textit{Wave Probe} & \textit{OSSI-010-002E Wave Staff} & \textit{2} & \textit{Cost per unit} & \textit{Total cost} & \textit{OSSI} & \textit{Material type} \\\hline
